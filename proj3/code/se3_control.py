...
class SE3Control(object):
    ...
    def __init__(self, quad_params):
        ...
        kd1 = 5#4.68 # 5#4#5#6#5#2#3
        kd3 = 7#6.8 #6#7#5#6#11.6#2
        self.kd = np.diag(np.array([kd1, kd1, kd3]))

        kp1 = 7#6.98#4#10#2.05#3
        kp3 = 19#18.98#10#5#20#33.64#
        self.kp = np.diag(np.array([kp1, kp1, kp3]))

        kr1 = 2660#2666 #450#158#450#3364#20#100#50
        kr3 = 160#166 #25#158#25#3364#50
        self.kr = np.diag(np.array([kr1, kr1, kr3]))

        kw1 = 140#136 #40#25.2#10#40#116#7#6.25
        kw3 = 90#88 # 10# 66#10#116#6.25
