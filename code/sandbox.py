...
from world_traj_const_acceleration import WorldTraj
...
ax.legend(handles=[
    ...
    Line2D([], [], color='purple', linestyle='', marker='.', markersize=3, label='Sparse Waypoints'),
    Line2D([], [], color='black', linewidth=3, label='Trajectory')],
    loc='upper right')
